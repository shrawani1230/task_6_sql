...
select p.product_id as product_id,p.category as product_categoty,
s.customer_id as customer_id, s.product_id as product_id from sales as s inner join product as p
